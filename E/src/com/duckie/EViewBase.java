...
public abstract class EViewBase extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    public boolean openCamera() {		
        ...
        mCamera.setPreviewCallbackWithBuffer(new PreviewCallback() {
            public void onPreviewFrame(byte[] data, Camera camera) {
                synchronized (EViewBase.this) {
                    System.arraycopy(data, 0, mFrame, 0, data.length);
                    EViewBase.this.notify(); 
                }
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {		//<S>: when is a surface destroyed?
